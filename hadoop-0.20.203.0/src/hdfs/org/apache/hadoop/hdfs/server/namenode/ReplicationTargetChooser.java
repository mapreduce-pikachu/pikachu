...
class ReplicationTargetChooser {
  ...
  DatanodeDescriptor[] chooseTarget(int numOfReplicas,
    ...
    System.out.println("chooseTarget: numReplicas = " + numOfReplicas + " " + "ClusterSize = " + clusterSize);
    System.out.println("chooseTarget: Chosen node size = " + choosenNodes.size());
    ...
    System.out.println("chooseTarget: MaxNodes = " + maxNodesPerRack);
    ...
    System.out.println("chooseTarget: Localnode: " + localNode.toString());
    System.out.println("chooseTarget: All nodes: " + results.toString());
  ...
  private DatanodeDescriptor chooseLocalNode(
    ...
    {
    	System.out.println("chooseLocalNode: Yes There is No Local Node");
    ...
    if (!excludedNodes.contains(localMachine)) {
      ...
      if (isGoodTarget(localMachine, blocksize,
    	  ...
    	  System.out.println("chooseLocalNode: Local node found: " + localMachine.toString());
  ...
  private DatanodeDescriptor[] chooseRandom(int numOfReplicas, 
    ...
    System.out.println("chooseRandom: " + numOfAvailableNodes);
